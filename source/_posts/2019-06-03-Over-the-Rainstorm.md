...
主要的傷害技能之一, 大範圍的持續傷害. 傷害部分除了撐 ATK 外, 稱高 AGI 和 DEX 也有相當效果, 而時光靴附魔鷹眼能將火力推至更高境界. 詠唱部分, 素質無詠對弓箭手通常沒有問題, 固詠 0.5 秒可以由{% link 時光靈巧戰靴 https://rd.fharr.com/item-22008.html %}或是{% link 時光超越者之靴 https://rd.fharr.com/item-22202.html %}來消除. (還可以附魔鷹眼, 一舉兩得.)
...
舞孃弱勢到連一轉弓箭手的技能都要拿出來用.（￣▽￣）不過在有兩顆{% link 翡翠戒指 https://rd.fharr.com/item-28573.html %}和{% link 影子弓箭手耳環 https://rd.fharr.com/item-28392.html %}後可以把這技能大大強化: 雙翡翠可以把二連矢的傷害倍率提升到 1710%, 而影子弓箭手耳環在使用二連矢的時候還可以額外觸發增傷的效果. 所以可以作為在大暴雨和箭雨風暴都在冷卻的時候使用.

至於其他攻擊技能..
{% blockquote %}
{% asset_img SkillSound1.jpg 殘響 %} 殘響: 設置音波陷阱, 對接觸到的敵人造成物理和魔法傷害.
{% asset_img SkillSound2.jpg 重金屬音樂 %} 重金屬音樂: 對指定對象造成魔法傷害並附加混亂.
{% endblockquote %}
...
以下輔助技能都要帶一把鞭子才可以使用, 有增加攻擊速度的{% link 彩帶執鞭 https://rd.fharr.com/item-1989.html %}或是加素質的{% link 電鰻鞭 https://rd.fharr.com/item-1972.html %}都不錯, 特殊取向的可以使用{% link 女王的鞭子 https://rd.fharr.com/item-1972.html %}. （￣▽￣）
...
{% blockquote %}
{% asset_img SkillDance1.jpg 搖擺舞 %} 搖擺舞: 增加自己和隊友的攻擊和移動速度.
{% asset_img SkillDance2.jpg 月光小夜曲 %} 月光小夜曲: 增加自己和隊友的 MATK.
{% asset_img SkillDance3.jpg 戀人交響曲 %} 戀人交響曲: 增加自己和隊友的 MDEF.
{% endblockquote %}
...
{% blockquote %}
{% asset_img SkillDance4.png 豐年頌 %} 豐年頌: 增加最大 HP 和每秒 HP 回復.
{% asset_img SkillDeath.jpg 死亡峽谷 %} 死亡峽谷: 復活陣亡的同伴.
{% endblockquote %}
豐年頌可以增加最大 HP, 死亡峽谷能無視地獄的權復活陣亡的同伴, 不過玩到現在沒看到有 boss 會放, 所以帶天葉就好了. （￣▽￣）
以上兩組技能都要消耗一個淚水.

{% blockquote %}
{% asset_img SkillDanceM1.png 雷拉多露水 %} 雷拉多露水: 三轉合奏, 增加最大 HP.
{% asset_img SkillDanceM2.png 魔力之歌 %} 魔力之歌: 三轉合奏, 增加每秒 SP 回復.
{% asset_img SkillDanceM3.png 與狼共舞 %} 與狼共舞: 三轉合奏, 增加攻擊速度和減少固詠
{% endblockquote %}
...
{% blockquote %}
{% asset_img SkillDance23.jpg 為您服務 %} 為您服務: 範圍內的所有玩家除了自己增加 SP 和減少 SP 消耗
{% asset_img SkillDance21.jpg 哼唱曲 %} 哼唱曲: 範圍內的所有玩家除了自己增加命中率
{% asset_img SkillDance22.jpg 幸運之吻 %} 幸運之吻: 範圍內的所有玩家除了自己增加暴擊率和暴擊傷害
{% endblockquote %}
...
卡片: 邪弓 / 深淵 / 真浪跡 / 巴基利
{% endblockquote %}
由於這兩把弓帶有箭雨風暴, 所以完全不建議使用其他弓, 就算有減大暴雨延遲的{% link 風暴之弓 https://rd.fharr.com/item-18123.html %}和{% link 納西斯弓 https://rd.fharr.com/item-18170.html %}都不考慮.
...
{% blockquote %}
衣服: {% link 魔王的外袍 https://rd.fharr.com/item-2374.html %} / {% link 艾克賽利翁外套 https://rd.fharr.com/item-15128.html %} / {% link 惡言外袍 https://rd.fharr.com/item-15147.html %}
卡片: 馬克 / 幽暗夢靨
{% endblockquote %}
...
{% blockquote %}
裝飾品: {% link 音波擴增器 https://rd.fharr.com/item-2899.html %} / {% link 巴庫暴龍符紋 https://rd.fharr.com/item-2910.html %} / {% link 混沌之墜 https://rd.fharr.com/item-2991.html %} & {% link 和諧之墜 https://rd.fharr.com/item-2990.html %} / {% link 漩渦之墜 https://rd.fharr.com/item-2992.html %} / {% link 國王守護之戒 https://rd.fharr.com/item-28483.html %} / {% link 翡翠戒指 https://rd.fharr.com/item-28573.html %}
