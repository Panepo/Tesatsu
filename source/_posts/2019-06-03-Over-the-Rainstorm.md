...
至於其他攻擊技能..
{% blockquote %}
{% asset_img SkillSound1.jpg 殘響 %} 殘響: 引爆範圍只有 1 格而且傷害會分散, 實戰根本沒有用途, 不過倒是可以埋在副本王出來的格子上來個一次引爆.
{% asset_img SkillSound2.jpg 重金屬音樂 %} 重金屬音樂: 強制無屬性, 獨立延遲 5 秒又是純魔法傷害而且傷害倍率也不高.
{% endblockquote %}
...
{% blockquote %}
{% asset_img SkillDanceM1.jpg 雷拉多露水 %} 雷拉多露水: 三轉合奏, 增加最大 HP.
{% asset_img SkillDanceM2.jpg 魔力之歌 %} 魔力之歌: 三轉合奏, 增加每秒 SP 回復.
{% asset_img SkillDanceM3.jpg 與狼共舞 %} 與狼共舞: 三轉合奏, 增加攻擊速度和減少固詠
{% endblockquote %}
